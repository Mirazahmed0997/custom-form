    ...
    <div className='form' style={containerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        {[
          ...
          "৫. সভাপতি",
          "৬. সম্পাদক (প্রাথমিক/কেন্দ্রীয়/জাতীয়)",
          "৭. তারিখ ",
          "৮. সমিতির শ্রেণি",
          "৯ . সমিতির সদস্য সংখ্যা",
          "১0. সমিতির সদস্য নির্বাচনী ও কর্ম এলাকা",
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '50px' }}>
        ...
        <div style={{ width: '300px' }}>
          ...
          <div style={{ display: 'flex' }}>স্বাক্ষর : <input type="file" ></input></div>(png/jpg/jpeg)
