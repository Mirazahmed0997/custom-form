    ...
    <div className="form-container">
      <div className="form-paper">
        ...
        <div className="society-name">
         <input className="line"></input>সমবায় সমিতি লিঃ
        </div>
     ...
     <div className="note-box-fields">
          ...
          উপজেলা সমবায় অফিসার কর্তৃক প্রত্যায়িত এক কপি ছবি সংযুক্ত করিতে
          হইবে।
        </div>
     </div>
      ...
      <div className="fields">
        ...
        <div className="paragraph">
          ০৭. এই পরিচয়পত্র ধারী ব্যক্তি বাংলাদেশ জাতীয় সমবায় ইউনিয়ন,
          সমবায় ব্যাংক ভবন (৮ম তলা), ৯-ডি, মতিঝিল বা/এ, ঢাকা-১০০ এর সদস্য
          পদে আবেদন করার ক্ষমতা প্রাপ্ত।
        </div>
       ...
       <div className="signature">
        ...
        <div className="signature-lines">
          <div>(০১) <input type="file" className="line" ></input>(png/jpg/jpeg)</div>
          <div>(০২) <input type="file" className="line" ></input>(png/jpg/jpeg)</div>
          <div>(০৩) <input type="file" className="line" ></input>(png/jpg/jpeg)</div>
        </div>
